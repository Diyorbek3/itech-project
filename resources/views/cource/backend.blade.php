        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <div class="d-flex align-items-center gap-2"><i class="fas fa-users text-primary"></i><span>{{ __('messages.backend_students') }} talaba</span></div>
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        <div class="skill-item">
                            ...
                            <div>
                                <div class="skill-title">{{ __('messages.backend_module1_title') }}</div>
                                <div class="skill-desc">{{ __('messages.backend_module1_desc') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="skill-item">
                            <div class="skill-check"><i class="fas fa-check"></i></div>
                            <div>
                                <div class="skill-title">{{ __('messages.backend_module2_title') }}</div>
                                <div class="skill-desc">{{ __('messages.backend_module2_desc') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="skill-item">
                            <div class="skill-check"><i class="fas fa-check"></i></div>
                            <div>
                                <div class="skill-title">{{ __('messages.backend_module3_title') }}</div>
                                <div class="skill-desc">{{ __('messages.backend_module3_desc') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="skill-item">
                            <div class="skill-check"><i class="fas fa-check"></i></div>
                            <div>
                                <div class="skill-title">{{ __('messages.backend_module4_title') }}</div>
                                <div class="skill-desc">{{ __('messages.backend_module4_desc') }}</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="skill-item">
                            <div class="skill-check"><i class="fas fa-check"></i></div>
                            <div>
                                <div class="skill-title">{{ __('messages.backend_module5_title') }}</div>
                                <div class="skill-desc">{{ __('messages.backend_module5_desc') }}</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="price-card">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <span class="fw-bold">{{ __('messages.backend_duration') }}</span>
                    </div>
                    <div class="d-flex justify-content-between mb-2">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4">
            <div class="modal-header border-0">
                <h5 class="modal-title fw-bold">{{ __('messages.backend_title') }} {{ __('messages.enroll_modal_title') }}</h5>
