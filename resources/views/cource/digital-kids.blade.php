        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <div class="d-flex align-items-center gap-2"><i class="fas fa-users text-primary"></i><span>{{ __('messages.digital_kids_students') }} {{ __('messages.students_suffix') }}</span></div>
                ...
                <div class="tech-stack">
                    <span class="tech-badge">{{ __('messages.digital_kids_tech_1') }}</span>
                    <span class="tech-badge">{{ __('messages.digital_kids_tech_2') }}</span>
                    <span class="tech-badge">{{ __('messages.digital_kids_tech_3') }}</span>
                    <span class="tech-badge">{{ __('messages.digital_kids_tech_4') }}</span>
                    <span class="tech-badge">{{ __('messages.digital_kids_tech_5') }}</span>
                    <span class="tech-badge">{{ __('messages.digital_kids_tech_6') }}</span>
                </div>
            </div>
    ...
    <div class="row g-4">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6">
                        <div class="skill-item">
                            ...
                            <div>
                                <div class="skill-title">{{ __('messages.digital_kids_module'.$i.'_title') }}</div>
                                <div class="skill-desc">{{ __('messages.digital_kids_module'.$i.'_desc') }}</div>
                            </div>
                        </div>
                    </div>
                    @endfor
        ...
        <div class="col-lg-4">
            <div class="price-card">
                ...
                <hr>
                <div class="mb-3">
                    <div class="d-flex justify-content-between mb-2"><span><i class="fas fa-clock me-2 text-primary"></i> {{ __('messages.course_duration_label') }}</span><span class="fw-bold">{{ __('messages.digital_kids_duration') }}</span></div>
...
<div id="customModal" class="custom-modal-overlay">
    <div class="modal-form-container">
        ...
        <p>{{ __('messages.digital_kids_title') }} {{ __('messages.modal_enroll_subtitle') }}</p>
