        ...
        <div class="col-lg-8">
            ...
            <div class="info-card">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6"><div class="skill-item"><div class="skill-check"><i class="fas fa-check"></i></div><div><div class="skill-title">Git & GitHub</div><div class="skill-desc">Versiyalarni boshqarish, loyihalarni joylashtirish</div></div></div></div>
                </div>
            </div>
            <div class="info-card">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content rounded-4">
            <div class="modal-header border-0">
                <h5 class="modal-title fw-bold">Frontend kursiga yozilish</h5>
