...
<div class="container py-4 py-md-5">
    <div class="course-hero">
        <div class="row align-items-center">
            <div class="col-lg-8">
                <span class="course-badge"><i class="fas fa-laptop-code me-2"></i> Boshlang'ich daraja</span>
                <h1 class="course-title">Kompyuter savodxonligi</h1>
                <p class="course-description">Kompyuterni noldan boshlab o'rganing. Windows operatsion tizimi, ofis dasturlari, internetdan foydalanish va xavfsizlik asoslari.</p>
                ...
                <div class="tech-stack">
                    ...
                    <span class="tech-badge">Internet</span>
                    <span class="tech-badge">Email</span>
                </div>
            </div>
            <div class="col-lg-4 text-center d-none d-lg-block">
                <i class="fas fa-laptop" style="font-size: 100px; color: rgba(59,130,246,0.5);"></i>
            </div>
        </div>
    </div>
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="info-card">
                ...
                <p class="text-secondary">Kompyuter savodxonligi kursida siz kompyuterni noldan boshlab o'rganasiz. Windows operatsion tizimi, Word matn muharriri, Excel jadval dasturi, internet va elektron pochtadan foydalanish ko'nikmalarini egallaysiz.</p>
            </div>
            <div class="info-card">
                <h3 class="fw-bold mb-3">📚 O'quv dasturi</h3>
                <div class="row g-2">
                    <div class="col-md-6"><div class="skill-item"><div class="skill-check"><i class="fas fa-check"></i></div><div><div class="skill-title">Windows OS</div><div class="skill-desc">Operatsion tizim asoslari, fayl va papkalar bilan ishlash</div></div></div></div>
                    <div class="col-md-6"><div class="skill-item"><div class="skill-check"><i class="fas fa-check"></i></div><div><div class="skill-title">Microsoft Word</div><div class="skill-desc">Matn muharriri, hujjat yaratish va formatlash</div></div></div></div>
                    <div class="col-md-6"><div class="skill-item"><div class="skill-check"><i class="fas fa-check"></i></div><div><div class="skill-title">Microsoft Excel</div><div class="skill-desc">Jadvallar, formulalar, diagrammalar yaratish</div></div></div></div>
                    <div class="col-md-6"><div class="skill-item"><div class="skill-check"><i class="fas fa-check"></i></div><div><div class="skill-title">Internet va Email</div><div class="skill-desc">Brauzerlardan foydalanish, elektron pochta, xavfsizlik</div></div></div></div>
                </div>
            </div>
            <div class="info-card">
                <h3 class="fw-bold mb-3">👨‍💻 Kimlar uchun?</h3>
                <p class="text-secondary">Kompyuterni noldan o'rganishni xohlovchilar, ish joyida kompyuter ko'nikmalarini rivojlantirmoqchi bo'lganlar, katta yoshdagi foydalanuvchilar, ofis dasturlarini o'rganmoqchi bo'lganlar.</p>
            </div>
            <div class="teacher-card">
                <div class="teacher-avatar"><i class="fas fa-chalkboard-user"></i></div>
                <div>
                    <div class="teacher-name">Mahmudova Nilufar</div>
                    <div class="teacher-position">Kompyuter savodxonligi bo'yicha ekspert</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="price-card">
                <div class="text-center mb-3">
                    <span class="price-old">550,000 so'm</span>
                    <div class="price-new">450,000 so'm</div>
...
<div id="customModal" class="custom-modal-overlay">
    <div class="modal-form-container">
        ...
        <p>Kompyuter savodxonligi kursiga ariza qoldiring</p>
...
<script>
    (function() {
        ...
        // Kurs nomini avtomatik olish
        const courseName = document.querySelector('.course-title')?.innerText || "Kompyuter savodxonligi";
