    ...
    <div class="course-hero p-4 p-md-5 mb-5 shadow-lg">
        <div class="row align-items-center">
            <div class="col-lg-7">
                ...
                <h1 class="display-3 fw-bold mb-3">{!! __('messages.computer_title') !!}</h1>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-6">
                            <div class="p-4 rounded-4 shadow-sm border bg-white d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1">{{ __('messages.computer_tech1_title') }}</h5>
                                    <p class="text-secondary mb-0 small">{{ __('messages.computer_tech1_desc') }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-4 rounded-4 shadow-sm border bg-white d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="fw-bold mb-1">{{ __('messages.computer_tech2_title') }}</h5>
                                    <p class="text-secondary mb-0 small">{{ __('messages.computer_tech2_desc') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-5 d-none d-lg-block">
                <img src="https://img.icons8.com/color/480/windows-11.png" alt="Computer Literacy" class="img-fluid rounded-4 shadow-2xl float-end" style="max-height: 300px;">
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <span class="fw-bold">{{ __('messages.computer_duration_value') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            ...
                            <span class="fw-bold">{{ __('messages.computer_mentor_value') }}</span>
                        </div>
                    </div>
                    ...
                    <div class="text-center mb-4">
                        ...
                        <h2 class="fw-bold text-primary mb-0">{{ __('messages.computer_new_price') }} <small class="fs-6">{{ __('messages.computer_price_period') }}</small></h2>
                    </div>
                    ...
                    <p class="text-center small text-muted mb-0">
                        ...
                        {{ __('messages.computer_certificate_text') }}
                    </p>
                </div>
            </div>
        </div>
