...
<style>
    ...
    .form-group-custom input { width: 100%; padding: 1rem 1.3rem; border-radius: 18px; border: 1.5px solid #e2e8f0; outline: none; font-size: 1rem; }
    .btn-submit-custom { background: #11274c; color: white; border: none; width: 100%; padding: 1.1rem; border-radius: 50px; font-weight: 700; cursor: pointer; }
    ...
    <div class="course-hero">
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 text-center d-none d-lg-block">
                <i class="fas fa-chart-bar" style="font-size: 100px; color: rgba(59,130,246,0.4);"></i>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="price-card">
                ...
                <hr>
                <div class="mb-3">
                    <div class="d-flex justify-content-between mb-2"><span>Davomiyligi:</span><span class="fw-bold">{{ __('messages.data_analytics_duration') }}</span></div>
                    <div class="d-flex justify-content-between mb-2"><span>Tili:</span><span class="fw-bold">O'zbek</span></div>
                    <div class="d-flex justify-content-between"><span>Sertifikat:</span><span class="fw-bold">Mavjud</span></div>
                </div>
                <button id="openEnrollModal" class="btn btn-enroll">
...
<div id="customEnrollModal" class="custom-modal-overlay">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // TIZIMGA KIRGANLIGINI TEKSHIRISH (PHP dan JS ga uzatish)
        const isLoggedIn = {{ auth()->check() ? 'true' : 'false' }};
        
        const modal = document.getElementById('customEnrollModal');
        ...
        if (openBtn) {
            openBtn.addEventListener('click', function(e) {
                ...
                if (!isLoggedIn) {
                    ...
                    // Tizimga kirgan bo'lsa modalni ochish
