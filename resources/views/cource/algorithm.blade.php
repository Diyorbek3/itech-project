        ...
        <div class="col-lg-8">
            ...
            <div class="info-card">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6"><div class="skill-item"><div class="skill-check"><i class="fas fa-check"></i></div><div><div class="skill-title">Graf algoritmlari</div><div class="skill-desc">BFS, DFS, Dijkstra, Floyd-Warshall</div></div></div></div>
                    <div class="col-md-6"><div class="skill-item"><div class="skill-check"><i class="fas fa-check"></i></div><div><div class="skill-title">Dinamik dasturlash</div><div class="skill-desc">Knapsack, LCS, Fibonacci optimizatsiyasi</div></div></div></div>
                </div>
            </div>
            <div class="info-card">
...
<!-- Custom Modal - Python kursidagi kabi -->
