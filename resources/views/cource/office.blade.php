        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <div class="tech-stack">
                    ...
                    <span class="tech-badge">PowerPoint</span>
                    <span class="tech-badge">{{ __('messages.office_tech_archive') }}</span>
                    <span class="tech-badge">{{ __('messages.office_tech_document') }}</span>       
                </div>
            </div>
            <div class="col-lg-4 text-center d-none d-lg-block">
                <i class="fas fa-building" style="font-size: 100px; color: rgba(59,130,246,0.5);"></i>
            </div>
        </div>
    </div>
    <div class="row g-4">
        <div class="col-lg-8">
            ...
            <div class="info-card">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-6"><div class="skill-item"><div class="skill-check"><i class="fas fa-check"></i></div><div><div class="skill-title">{{ __('messages.office_module3_title') }}</div><div class="skill-desc">{{ __('messages.office_module3_desc') }}</div></div></div></div>
            ...
            <div class="teacher-card">
                ...
                <div>
                    <div class="teacher-name">{{ __('messages.office_teacher') }}</div>
                    <div class="teacher-position">{{ __('messages.office_teacher_position') }}</div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="price-card">
                ...
                <button id="openModalBtn" class="btn btn-enroll text-white">
                    <i class="fas fa-bolt me-2"></i> {{ __('messages.office_enroll_button') }}
                </button>
