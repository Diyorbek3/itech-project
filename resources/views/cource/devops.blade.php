        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <div class="d-flex align-items-center gap-2"><i class="fas fa-clock text-primary"></i><span>{{ __('messages.devops_duration') }}</span></div>
                    <div class="d-flex align-items-center gap-2"><i class="fas fa-users text-primary"></i><span>{{ __('messages.devops_students') }} {{ __('messages.students_suffix') }}</span></div>
                ...
                <div class="tech-stack">
                    <span class="tech-badge">{{ __('messages.devops_tech_1') }}</span>
                    <span class="tech-badge">{{ __('messages.devops_tech_2') }}</span>
                    <span class="tech-badge">{{ __('messages.devops_tech_3') }}</span>
                    <span class="tech-badge">{{ __('messages.devops_tech_4') }}</span>
                    <span class="tech-badge">{{ __('messages.devops_tech_5') }}</span>
                    <span class="tech-badge">{{ __('messages.devops_tech_6') }}</span>
                </div>
            </div>
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="info-card">
                ...
                <p class="text-secondary">{{ __('messages.devops_full_desc') }}</p>
            </div>
            ...
            <div class="info-card">
                ...
                <p class="text-secondary">{{ __('messages.devops_for_who') }}</p>
            </div>
...
<div id="customModal" class="custom-modal-overlay">
    <div class="modal-form-container">
        ...
        <h2 class="modal-title-custom"><i class="fas fa-pen-nib"></i> {{ __('messages.modal_enroll_title') }}</h2>
        <p class="modal-subtitle-custom">{{ __('messages.devops_title') }} {{ __('messages.modal_enroll_subtitle') }}</p>
        <form id="applicationForm">
            @csrf
            <div class="form-group-custom">
                <label><i class="fas fa-user"></i> {{ __('messages.form_name_label') }}</label>
                <input type="text" id="fullName" placeholder="{{ __('messages.form_name_placeholder') }}" required>
            </div>
            <div class="form-group-custom">
                <label><i class="fas fa-phone-alt"></i> {{ __('messages.form_phone_label') }}</label>
                <input type="tel" id="phone" placeholder="{{ __('messages.form_phone_placeholder') }}" required>
            </div>
            <button type="submit" class="btn-submit-custom"><i class="fab fa-telegram-plane"></i> {{ __('messages.form_submit_button') }}</button>
        </form>
        <div class="modal-footer-note">{{ __('messages.form_privacy_note') }}</div>
    </div>
</div>
...
<div id="adminToast" class="admin-toast">
    ...
    <div>
        <div class="fw-bold" style="font-size: 0.9rem; color: #1e293b;">{{ __('messages.toast_success_title') }}</div>
        <div style="font-size: 0.75rem; color: #64748b;">{{ __('messages.toast_note') }}</div>
    </div>
