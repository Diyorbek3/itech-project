        ...
        <div class="row align-items-center">
            <div class="col-lg-8">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <div class="d-flex align-items-center gap-2"><i class="fas fa-users text-primary"></i><span>{{ __('messages.accounting_students') }} {{ __('messages.students_suffix') }}</span></div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="price-card">
                ...
                <hr>
                <div class="mb-3">
                    <div class="d-flex justify-content-between mb-2"><span><i class="fas fa-clock me-2 text-primary"></i> {{ __('messages.course_duration_label') }}</span><span class="fw-bold">{{ __('messages.accounting_duration') }}</span></div>
...
<div id="customModal" class="custom-modal-overlay">
    <div class="modal-form-container">
        ...
        <p>{{ __('messages.accounting_title') }} {{ __('messages.modal_enroll_subtitle') }}</p>
