...
return [
    ...
    'certificate_given' => 'Сертификат выдается',
    ...
    'per_month' => '/в месяц',
    'support_24_7' => 'Круглосуточная поддержка 24/7',
    ...
    'register_for_course' => 'Запись на курс',
    'full_name' => 'Полное имя',
    ...
    'valid_phone' => 'Номер должен быть в формате +998XXXXXXXXX',
    'success' => 'Успешно!',
    'application_accepted' => 'Ваша заявка принята. Мы свяжемся с вами',
